...
public class SignUp extends JFrame implements ActionListener,MouseListener {
    ...
    public SignUp(){
        ...
        l4.setBounds(120,180,200,30);
        l4.setFont(new Font("Times New Roman",Font.PLAIN,19));
        p1.add(l4);

        //mailBox
        t3 =new JTextField();
        t3.setBounds(120,210,380,40);
        ...
        l6.setBounds(120,320,200,40);
        l6.setFont(new Font("Times New Roman",Font.PLAIN,19));
        p1.add(l6);

        //usernameBox
        t4 =new JTextField();
        t4.setBounds(120,355,380,40);
        ...
        l7.setBounds(120,400,200,40);
        l7.setFont(new Font("Times New Roman",Font.PLAIN,19));
        p1.add(l7);

        //roundBox1
        r1=new JRadioButton("Yes");
        r1.setBounds(120,430,60,30);
        ...
        l8.setBounds(120,450,200,40);
        l8.setFont(new Font("Times New Roman",Font.PLAIN,19));
        p1.add(l8);

        //nidBox
        t5 =new JTextField();
        t5.setBounds(120,480,380,40);
        t5.setFont(new Font("Times new roman",Font.PLAIN,17));
